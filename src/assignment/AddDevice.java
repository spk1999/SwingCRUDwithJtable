...
public class AddDevice extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(deviceController.addDevice(new NetworkDevice(null,name.getText(),category.getText(),model.getText())))
        {
            JOptionPane.showMessageDialog(null, "Device Added Sucessfully");
           super.setVisible(false);
           new Home().setVisible(true);
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Failed to add device");
           super.setVisible(false);
           new Home().setVisible(true);
        }
